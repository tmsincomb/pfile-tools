...
class R27_001PfileHeader(LittleEndianStructure):
    ...
    _fields_ = [
        ...
        ('pad_9p', c_char * 36),
        ('num_difdirs', c_short),       # number of diffusion directions
        ('pad_10', c_char * 197082),    
        ('aps_r1', c_int),		# rdb_hdr_ps_aps_r1
        ('aps_r2', c_int),
        ('aps_tg', c_int),
        ('aps_frequency', c_uint),
        ('scale_i', c_float),
        ...
        ('end_ras', c_char),
        ('pad_28', c_char * 1769),
        ('x_field_of_view', c_float),	# MRIMAGEDATATYPE dfov
        ('y_field_of_view', c_float),
        ('scan_duration', c_float),
        ('z_thickness', c_float),
        ('pad_29', c_char * 36),
        ...
        ('psd_name', c_char * 33),
        ('pad_36', c_char * 84),
        ('coil_name', c_char * 17),     # MRIMAGEDATATYPE cname
        ('pad_37', c_char * 115),
        ('long_coil_name', c_char * 24),# MRIMAGEDATATYPE GEcname
        ('pad_38', c_char * 543)]
